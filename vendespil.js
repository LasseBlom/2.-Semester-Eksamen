...
document.getElementById("spiller1-navn").textContent = localStorage.getItem("spiller1") || "EMIL PEDERSEN";
document.getElementById("spiller2-navn").textContent = localStorage.getItem("spiller2") || "IDA JENSEN";
